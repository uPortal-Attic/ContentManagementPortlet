...
public class VideoAttachmentThumbnailCreator extends MultimediaAttachmentThumbnailCreator {

	public VideoAttachmentThumbnailCreator(final Attachment attachment, final ResourceRequest req,
	...
	protected String getPathToAttachmentImage(final File attachmentFile) {
		return getRequest().getContextPath() + "/" + IMAGES_DIRECTORY_NAME + "/video.png";
	}
