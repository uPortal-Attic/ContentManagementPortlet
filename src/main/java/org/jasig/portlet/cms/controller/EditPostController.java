...
public class EditPostController extends AbstractPortletController {
  ...
  private void savePost(final ActionRequest request, final BindingResult result, Post post, boolean postIsScheduled, String scheduledDate,
      boolean removeExistingPost) throws PortletRequestBindingException, JcrRepositoryException {
  ...
  protected void handleAction(final ActionRequest request, final ActionResponse response,
      ...
      @RequestParam(value = "removeExistingPost", required = false) boolean removeExistingPost, @ModelAttribute Post post, BindingResult result)
      throws Exception {
  ...
  protected ModelAndView handleRenderSelectPostFromSearchResults(final RenderRequest req, final RenderResponse res, @ModelAttribute("post") Post post)
      throws Exception {
  ...
  protected void handleActionRemovePostAttachment(final ActionRequest request, final ActionResponse resp, @RequestParam("postPath") String postPath,
      @RequestParam("attachmentPath") String attachmentPath) throws Exception {
