...
public final class PortletPreferencesWrapper {
    ...
    private final static Log     logger                                 = LogFactory.getLog(PortletPreferencesWrapper.class);
    ...
    private void checkForPreferencesKeys() {
        ...
        if (!map.containsKey(PREF_KEY_ATTACHMENT_THUMBNAILS_ENABLED))
            setAttachmentThumbnailsEnabled(DEFAULT_XSS_VALIDATION_ENABLED);
    }
