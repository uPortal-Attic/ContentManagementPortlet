...
class AudioAttachmentThumbnailCreator extends MultimediaAttachmentThumbnailCreator {

	public AudioAttachmentThumbnailCreator(final Attachment attachment, final ResourceRequest req, final PortletContext ctx,
	...
	protected String getPathToAttachmentImage(final File attachmentFile) {
		return getRequest().getContextPath() + "/" + IMAGES_DIRECTORY_NAME + "/audio.png";
	}
